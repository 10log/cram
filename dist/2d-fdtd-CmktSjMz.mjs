...
import { p as r, t as i } from "./renderer-BeKP35ez.mjs";
import { g as a } from "./store-DRnKXLf0.mjs";
import { n as o, t as s } from "./editor-modes-Dl6UXVU3.mjs";
import { t as c } from "./solver-DCp-VMaM.mjs";
...
var M = 256, N = {
	...
	constructor(e) {
		...
		let t = [...a.getState().selectedObjects.values()].filter((e) => e.kind === "surface"), r = null;
		if (e ||= {}, t.length > 0) {
			r = t.length > 1 ? t[0].mergeSurfaces(t) : t[0], r.mesh.geometry.computeBoundingBox();
			let n = r.mesh.geometry.boundingBox;
			n && (e.width = n.max.x - n.min.x, e.height = n.max.y - n.min.y, e.offsetX = n.min.x, e.offsetY = n.min.y);
		}
		let o = e && e.width || N.width, s = e && e.height || N.height;
		this.offsetX = e && e.offsetX || N.offsetX, this.offsetY = e && e.offsetY || N.offsetY, this.cellSize = e && e.cellSize || Math.max(o, s) / M, this.nx = Math.ceil(o / this.cellSize), this.ny = Math.ceil(s / this.cellSize), this.width = this.nx * this.cellSize, this.height = this.ny * this.cellSize, this.dt = O(this.cellSize, this.waveSpeed), this.sources = {}, this.sourceKeys = [], this.receivers = {}, this.receiverKeys = [], this.walls = [], this.messageHandlers = [], this.eventListeners = [];
	...
	init() {
		...
		c !== null && console.error(c), this.clearShader = this.gpuCompute.createShaderMaterial(D.clearFrag, { clearTexture: { value: null } }), this.readLevelShader = this.gpuCompute.createShaderMaterial(D.readLevelFrag, {
			...
			stencilBuffer: !1,
			depthBuffer: !1
		}), this.eventListeners.push(t("RENDERER_UPDATED", () => {
...
//# sourceMappingURL=2d-fdtd-CmktSjMz.mjs.map