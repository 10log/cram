...
//#endregion
//#region src/common/global-vars.ts
function Ae() {
	return window.vars ?? (window.vars = {}), window.vars;
}
function je(e) {
	let t = Ae();
	Object.keys(t).forEach((n) => {
		t[n]?.uuid === e && delete t[n];
	});
}
//#endregion
...
}, Ne = (e) => e instanceof Array ? e : [e];
function Pe(e, t) {
	let n = new Me(e);
	return t && Ne(t).forEach((e) => n.watch(e)), n;
}
//#endregion
...
var { abs: Ie } = Math, Le = new F.Vector3(), Re = new F.Vector3();
new F.Vector3();
var ze = new F.Vector3(), I = new F.Vector3(), Be = new F.Vector3(), L = new F.Vector3(), R = new F.Plane(), z = new F.Vector4(), Ve = new F.Vector4(), He = new F.Vector4(), Ue = new F.Vector4();
function We(e, t) {
	return e.getPlane(R), z.set(R.normal.x, R.normal.y, R.normal.z, R.constant), Ve.set(t.a.x, t.a.y, t.a.z, 1), He.set(t.b.x, t.b.y, t.b.z, 1), Ue.set(t.c.x, t.c.y, t.c.z, 1), z.dot(Ve) > 0 || z.dot(He) > 0 || z.dot(Ue) > 0;
}
function Ge(e, t, n, r, i, a, o, s) {
	let c = se(e, Re, t), l = c && Le.copy(t).multiplyScalar(-1).angleTo(c), u = e.distance, d = n.map((e, t) => e * 10 ** (-r[t] * u / 10)), f = d.reduce((e, t) => e + t, 0), p = d.length > 0 ? f / d.length : 0, m = [...i, {
...
function Ke(e, t, n, r, i, a, o, s, c, l, u, d, f = 1, p = [], m) {
	...
	if (h.length > 0) {
		...
		_ > 0 && h.splice(0, _);
		{
			let a = se(h[0], Re, o), _ = a && Le.copy(o).multiplyScalar(-1).angleTo(a);
			p.push({
			...
			let y = a, b = y && ee(o, y, ze), x = h[0].object.parent, S = n.map((e) => x.scatteringFunction(e)), C = c.reduce((e, t) => e + t, 0) || 1, w = 0;
			...
			if (w /= C, Fe(w)) {
				...
				I.normalize(), b = ze.copy(I).add(y).normalize();
			}
			let T = h[0].distance, E = n.map((e, t) => {
				let n = c[t];
				if (n == null) return 0;
				let i = n * Ie(x.reflectionFunction(e, _));
			...
			if (b && y && f < s + 1) {
				...
				if (D > 0) return Ke(e, t, n, r, i, Be.copy(h[0].point).addScaledVector(y, de), b, s, E, l, u, d, f + 1, p, m);
			}
		}
		return {
			chain: p,
...
var { floor: U, abs: Je, max: Ye } = Math, Xe = () => new Worker(new URL(
	/* @vite-ignore */
...
function W(e, t, n, r = 1, i = 20) {
	...
	n.chain.slice(0, -1).forEach((e) => {
		...
		a.forEach((r, i) => {
			let o = Je(n.reflectionFunction(t[i], e.angle));
			a[i] = r * o;
		});
	});
	let o = _(b(a)), s = N(t, i);
...
async function Ze(e, t, n, r = 100, i, a, o = g.sampleRate, s, c) {
	...
	if (s && s.energyHistogram && s.energyHistogram.length > 0) {
		...
		m = D(m, t, n, r);
		let a = m.reduce((e, t) => Ye(e, t.length), 0) * 2;
...
async function Qe(e, t, n, r = 100, i, a, o = g.sampleRate, s, c, l) {
	...
	if (s && s.energyHistogram && s.energyHistogram.length > 0) {
		let e = j(s.energyHistogram, s.frequencies, s.crossfadeTime, s.histogramBinWidth), { tailSamples: t, tailStartSample: n } = M(e, o), r = U(s.crossfadeDuration * o);
		_ = D(_, t, n, r);
		let a = _.reduce((e, t) => Ye(e, t.length), 0) * 2;
...
function et(e, t) {
	return e.filter((e) => $e(e) > t).slice().sort((e, t) => e.time - t.time);
}
function tt(e, t) {
...
function dt(e) {
	return e.length === 0 ? {} : e[0] === ot ? lt(e) : st(e);
}
//#endregion
//#region src/compute/raytracer/export-playback.ts
var ft = /* @__PURE__ */ r(s()), { floor: pt } = Math, mt = "RAYTRACER_SET_PROPERTY";
function ht(e, t, n, r, i, a = 100, o = m(125, 8e3), s = 44100) {
	...
	let c = e[t[0]].sort((e, t) => e.time - t.time), l = c[c.length - 1].time + A, u = Array(o.length).fill(a), d = pt(s * l), p = [];
	...
	for (let e = 0; e < c.length; e++) {
		let t = V(B(c[e])), n = c[e].time, i = c[e].arrivalDirection || [
			...
			0,
			1
		], a = g.getGain(i), l = r(u, o, c[e], a).map((e) => e * t * _), d = pt(n * s);
	...
	for (let e = 0; e < o.length; e++) {
		...
		ft.default.saveAs(t, `${o[e]}_${i}.wav`);
	}
}
...
function wt(e, t, n) {
	...
	for (let e = 0; e < r.length; e++) {
		...
		if (u) for (let t = 0; t < u.count; t += 3) {
			...
			let n = o.length - 9, r = Ot(o[n], o[n + 1], o[n + 2], o[n + 3], o[n + 4], o[n + 5], o[n + 6], o[n + 7], o[n + 8]);
	...
	let { nodeArray: b, nodeCount: x } = Dt(g), S = n.length, C = new Float32Array(r.length * S * 2);
	for (let e = 0; e < r.length; e++) {
		let t = r[e];
		for (let r = 0; r < S; r++) {
			let i = (e * S + r) * 2;
...
function zt(e, t, n, r, i, a) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		let u = s.length > 0 ? s[s.length - 1].point : n, d = [
			u[0] - l.point[0],
			u[1] - l.point[1],
			u[2] - l.point[2]
		], f = Math.hypot(d[0], d[1], d[2]) || 1, p = [...s, l], m = l.bandEnergy ?? [];
		c.push({
			intersectedReceiver: !0,
			chain: p,
			chainLength: p.length,
...
var Bt = class {
	...
	async initialize(e, t, n, r) {
		...
		let a = i.device.limits.maxStorageBufferBindingSize, o = i.device.limits.maxBufferSize, s = Math.floor(Math.min(a, o) / 8192);
		...
		let h = this.device.createShaderModule({ code: kt });
	...
	async traceBatch(e, t, n) {
		...
		if (t === 0) return [];
		let r = Math.min(this.config.frequencies.length, At), i = /* @__PURE__ */ new ArrayBuffer(Rt), a = new Uint32Array(i), o = new Float32Array(i);
		...
		this.device.queue.writeBuffer(this.gpuParams, 0, i), this.device.queue.writeBuffer(this.gpuRayInputs, 0, e.buffer, e.byteOffset, t * Nt);
		...
		}), c = Math.ceil(t / jt), l = this.device.createCommandEncoder(), u = l.beginComputePass();
	...
	parseResults(e, t, n, r, i) {
		...
		for (let s = 0; s < r; s++) {
			let r = s * Pt, c = new Uint32Array(e.buffer, r * 4, Pt)[0], l = [];
			for (let t = 0; t < i; t++) l.push(e[r + 8 + t]);
			let u = [], d = [], f = s * Z;
			for (let e = 0; e < c; e++) {
				let n = (f + e) * It, r = new Uint32Array(t.buffer, n * 4, It), a = t[n], s = t[n + 1], c = t[n + 2], l = t[n + 3], p = r[4], m = t[n + 6], h = t[n + 7], g = [];
				for (let e = 0; e < i; e++) g.push(t[n + 8 + e]);
				let _;
				if (p >= o.surfaceCount) {
					let e = p - o.surfaceCount;
					_ = o.receiverUuidMap[e] ?? "", d.push(!0);
				} else _ = o.surfaceUuidMap[p] ?? "", d.push(!1);
				u.push({
					point: [
						a,
						s,
...
}, Vt = () => new Worker(new URL(
	/* @vite-ignore */
	"/assets/filter.worker-B2fYKvk6.js",
	"" + import.meta.url
)), { floor: Q, random: Ht, abs: $, asin: Ut } = Math;
...
var Wt = class extends _e {
	...
	dispose() {
		this._isRunning && (this._isRunning = !1, this._gpuRunning = !1, cancelAnimationFrame(this._rafId), this._rafId = 0, this.intervals.forEach((e) => window.clearInterval(e)), this.intervals = []), this._disposeGpu(), this.removeMessageHandlers(), je(this.uuid), u.scene.remove(this.rays), u.scene.remove(this.hits);
	}
	addSource(e) {
	...
	traceRay(e, t, n, r, i, a, o, s = 1, c = [], l) {
		return Ke(this.raycaster, this.intersectableObjects, this.frequencies, this._cachedAirAtt, this.rrThreshold, e, t, n, r, i, a, o, s, c, l);
	}
	...
	_pushPathWithEviction(e, t) {
		let n = f.getState().containers[e], r = t.chain[t.chain.length - 1], i = n?.position && r?.point ? qe(r.point, n.position) : 0;
		nt(t, this.c, i);
	...
	_addToEnergyHistogram(e, t) {
		Ct(this._energyHistogram, e, t, this.frequencies, this.c, this._histogramBinWidth, this._histogramNumBins);
	}
	step() {
		for (let e = 0; e < this.sourceIDs.length; e++) {
			this.__num_checked_paths += 1;
	...
	_resetConvergenceState() {
		let e = xt(this.frequencies.length);
	...
	_updateConvergenceMetrics() {
		St(this.convergenceMetrics, this._energyHistogram, this.frequencies, this.receiverIDs, this.__num_checked_paths, this.validRayCount, this._histogramBinWidth, this._histogramNumBins, this.uuid);
	}
	start() {
	...
	async calculateImpulseResponseForPair(e, t, n, r = 100, i = this.frequencies, a = g.sampleRate) {
		...
		return Ze(e, t, n, r, i, this.temperature, a, o, s);
	}
	async calculateImpulseResponseForDisplay(e = 100, t = this.frequencies, n = g.sampleRate, r) {
		...
		return Qe(this.receiverIDs, this.sourceIDs, this.paths, e, t, this.temperature, n, a, i, o);
	}
	clearRays() {
	...
	calculateReflectionLoss(e = this.frequencies) {
		let [t, n] = it(this.paths, this.room, this.receiverIDs, e);
	...
	calculateResponseByIntensity(e = this.frequencies, t = this.temperature) {
		let n = at(this.indexedPaths, this.receiverIDs, this.sourceIDs, e, t, this.intensitySampleRate);
	...
	async calculateImpulseResponse(e = 100, t = this.frequencies, n = g.sampleRate, r) {
		...
		if (this.hybrid) {
			console.log("Hybrid Calculation..."), s = et(a, this.transitionOrder);
			let e = {
				name: "HybridHelperIS",
				roomID: this.roomID,
			...
			}, r = tt(new Te(e, !0).returnSortedPathsForHybrid(this.c, l, t), this.transitionOrder);
			for (let e = 0; e < r.length; e++) {
	...
	async playImpulseResponse(e) {
		let t = await gt(this.impulseResponse, () => this.calculateImpulseResponse(void 0, void 0, void 0, e), this.uuid);
		this.impulseResponse = t.impulseResponse;
	}
	downloadImpulses(e, t = 100, n = m(125, 8e3), r = 44100) {
		ht(this.paths, this.receiverIDs, this.sourceIDs, (e, t, n, r) => this.arrivalPressure(e, t, n, r), e, t, n, r);
	}
	async downloadImpulseResponse(e, t = g.sampleRate, n) {
		let r = await _t(this.impulseResponse, () => this.calculateImpulseResponse(void 0, void 0, void 0, n), e, t);
		this.impulseResponse = r.impulseResponse;
	}
	async downloadAmbisonicImpulseResponse(e, t = 1, n) {
		let r = await vt(this.ambisonicImpulseResponse, (e) => this.calculateAmbisonicImpulseResponse(e, void 0, void 0, void 0, n), this.ambisonicOrder, t, e);
	...
	async playBinauralImpulseResponse(e = 1) {
		let t = await yt(this.binauralImpulseResponse, () => this.calculateBinauralImpulseResponse(e), this.uuid);
		this.binauralImpulseResponse = t.binauralImpulseResponse;
	}
	async downloadBinauralImpulseResponse(e, t = 1) {
		let n = await bt(this.binauralImpulseResponse, () => this.calculateBinauralImpulseResponse(t), e);
	...
	async _initGpu() {
		...
		let e = null;
		try {
			return e = new Bt(), !await e.initialize(this.room, this.receiverIDs, {
		...
		this._initGpu().then((t) => {
			...
			let n = this._gpuRayTracer.effectiveBatchSize, r = new Float32Array(n * 16), i = async () => {
				if (!(!this._gpuRunning || !this._isRunning || !this._gpuRayTracer)) try {
					...
					for (let e = 0; e < c.length; e++) {
						let { path: t, arrivals: n } = c[e];
						if (!t && n.length === 0) continue;
						let r = Math.min(Math.floor(e / Math.max(1, l)), this.sourceIDs.length - 1), i = this.sourceIDs[r], a = f.getState().containers[i].position;
						t && (t.source = i);
						for (let e of n) e.source = i;
						this._handleTracedPath(t ?? void 0, a, i, n);
					}
					this.flushRayBuffer(), u.needsToRender = !0;
					let d = Date.now();
...
t("RAYTRACER_CALL_METHOD", a), t("RAYTRACER_SET_PROPERTY", o), t("REMOVE_RAYTRACER", e), t("ADD_RAYTRACER", i(Wt)), t("RAYTRACER_CLEAR_RAYS", (e) => void n.getState().solvers[e].clearRays()), t("RAYTRACER_PLAY_IR", (e) => {
...
//# sourceMappingURL=raytracer-CS263trX.mjs.map