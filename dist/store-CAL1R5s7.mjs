import { C as e, D as t, E as n, O as r, T as i, _ as a, a as o, f as s, h as c, m as l, s as u, t as d, u as f, w as p, y as m } from "./FileSaver.min-DhK9iPpQ.mjs";
...
})), ie = /* @__PURE__ */ r((/* @__PURE__ */ e(((e, n) => {
	var r = E(), i = (A(), t(D).default).data, a = (P(), t(j).default).data, o = (ee(), t(F).default).data, s = ne(), c = re().Base64, l = new s(c.toUint8Array(i)), u = new s(c.toUint8Array(a)), d = new s(c.toUint8Array(o));
	function f(e, t) {
		return (e & t) !== 0;
	}
	function p(e, t, n) {
...
m("ASSIGN_MATERIAL", ({ material: e, target: t }) => {
	y.getState().set((n) => {
		f(t).forEach((t) => {
...
m("OPEN_MATERIAL_DRAWER", (e) => {
	z.getState().set((e) => {
		e.materialDrawerOpen = !0;
	});
}), m("TOGGLE_MATERIAL_SEARCH", () => {
	z.getState().set((e) => {
		e.materialDrawerOpen = !0;
	});
}), m("TOGGLE_RESULTS_PANEL", (e) => {
	z.getState().set((t) => {
		t.resultsPanelOpen = e === void 0 ? !t.resultsPanelOpen : e;
	});
}), m("SHOW_PROGRESS", ({ message: e, progress: t = -1, solverUuid: n }) => {
	z.getState().set((r) => {
		r.progress.visible = !0, r.progress.message = e, r.progress.progress = t, r.progress.solverUuid = n;
	});
}), m("UPDATE_PROGRESS", ({ progress: e, message: t }) => {
	z.getState().set((n) => {
...
m("ADD_RESULT", (e) => {
	B.getState().set((t) => void (t.results[e.uuid] = e)), z.getState().resultsPanelOpen || a("TOGGLE_RESULTS_PANEL", !0);
}), m("UPDATE_RESULT", ({ result: e }) => {
	B.getState().set((t) => void (t.results[e.uuid] = e));
}), m("REMOVE_RESULT", (e) => {
	B.getState().set((t) => {
		t.results = s([e], t.results);
	});
});
var He = (e, t, n) => {
	B.getState().set((r) => {
...
m("SOURCE_SET_PROPERTY", (e) => {
	e.property === "name" && He(e.uuid, e.value, "source");
}), m("RECEIVER_SET_PROPERTY", (e) => {
...
var Xe = /* @__PURE__ */ e(((e, t) => {
	(function(n) {
		var r;
		typeof e == "object" ? t.exports = n() : typeof define == "function" && define.amd ? define(n) : (typeof window < "u" ? r = window : typeof global < "u" ? r = global : typeof self < "u" && (r = self), r.objectHash = n());
	})(function() {
		return function e(t, r, i) {
			function a(s, c) {
				if (!r[s]) {
					...
					c = r[s] = { exports: {} }, t[s][0].call(c.exports, function(e) {
						var n = t[s][1][e];
						return a(n || e);
					}, c, c.exports, e, t, r, i);
				}
			...
			for (var o = typeof n == "function" && n, s = 0; s < i.length; s++) a(i[s]);
			return a;
		}({
			1: [function(e, t, n) {
...
var wt = /* @__PURE__ */ r(d()), Tt = () => {
	let e = u.getState().solvers, t = y.getState().containers, { projectName: n, version: r } = z.getState(), i = [], a = [];
...
m("SAVE", (e) => {
	...
	wt.default.saveAs(n, `${r}.json`), a("MARK_CLEAN", void 0), e && e();
});
var Et = () => {
...
m("OPEN", async (e) => {
	...
	Dt(async (t) => {
		...
		a("RENDERER_SHOULD_ANIMATE", !0), e && e();
	});
}), m("NEW", (e) => {
	...
	a("DESELECT_ALL_OBJECTS"), a("RESTORE_CONTAINERS", e.containers), a("RESTORE_SOLVERS", e.solvers), z.getState().set((t) => {
...
var Ot = () => {
	console.log("[Store] Resetting all stores..."), T(), o(), Ue(), Re(), Be(), Ke(), Ye(), console.log("[Store] All stores reset complete");
};
//#endregion
