import { Z as k, _ as y, $ as U, a0 as A, a1 as L, a2 as F, a3 as B, a4 as D, k as j, a5 as P, a6 as N, a7 as X, a8 as V, M as W, r as T, a9 as Y, aa as z, ab as G, ac as p, ad as K, ae as E, af as O, o as q, ag as Z, ah as M } from "./index-Cyx44W_I.mjs";
import { S as J } from "./solver-Co1OmpsL.mjs";
class Q {
  /**
...
` + o.fragmentShader;
    ...
    this.createShaderMaterial = f, this.createRenderTarget = function(n, i, o, d, c, g) {
      return n = n || e, i = i || t, o = o || D, d = d || D, c = c || y, g = g || y, new A(n, i, {
        wrapS: o,
        wrapT: d,
        minFilter: c,
        magFilter: g,
      ...
      const n = new Float32Array(e * t * 4), i = new B(n, e, t, F, L);
...
function H(v, e, t, r) {
  const a = [];
  let s, l, u, h, f, m, _, n, i, o, d;
  if (u = t - v, h = r - e, f = Math.abs(u), m = Math.abs(h), _ = 2 * m - f, n = 2 * f - m, m <= f)
    for (u >= 0 ? (s = v, l = e, i = t) : (s = t, l = r, i = v), a.push([s, l]), d = 0; s < i; d++)
      s = s + 1, _ < 0 ? _ = _ + 2 * m : (u < 0 && h < 0 || u > 0 && h > 0 ? l = l + 1 : l = l - 1, _ = _ + 2 * (m - f)), a.push([s, l]);
  else
...
class le extends J {
  ...
  init() {
    ...
    ]), a = S.waterVert, s = S.waterFrag, l = V, u = new U({
      uniforms: r,
      vertexShader: a,
      fragmentShader: s,
      side: l,
  ...
  addWall(e) {
    const t = x(Math.floor((e.x1 - this.offsetX) / this.cellSize), 0, this.nx - 1), r = x(Math.floor((e.y1 - this.offsetY) / this.cellSize), 0, this.nx - 1), a = x(Math.floor((e.x2 - this.offsetX) / this.cellSize), 0, this.nx - 1), s = x(Math.floor((e.y2 - this.offsetY) / this.cellSize), 0, this.nx - 1);
  ...
  addWallsFromSurfaceEdges(e) {
    ...
    for (let r = 0; r < t.count; r += 2) {
      let a = x(Math.floor((t.getX(r) - this.offsetX) / this.cellSize), 0, this.nx - 1), s = x(Math.floor((t.getY(r) - this.offsetY) / this.cellSize), 0, this.ny - 1), l = x(Math.floor((t.getX(r + 1) - this.offsetX) / this.cellSize), 0, this.nx - 1), u = x(Math.floor((t.getY(r + 1) - this.offsetY) / this.cellSize), 0, this.ny - 1);
  ...
  updateSourceTexture() {
    ...
    if (e) {
      for (let t = 0; t < this.sourceKeys.length; t++) {
        ...
        if (e[s + 0] = M(l, -2, 2, 0, 255), e[s + 1] = M(u, -2, 2, 0, 255), e[s + 3] = 0, this.sources[this.sourceKeys[t]].shouldClearPreviousPosition) {
...
//# sourceMappingURL=index-5ZSiGYJy.mjs.map
