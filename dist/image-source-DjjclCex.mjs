...
import { i as m, n as h, r as g, t as _ } from "./convert-GmiMppOk.mjs";
...
var H = class {
	...
	test() {
		...
		if (t !== null) {
			...
			for (let t = 0; t < r.length; t++) r[t].isvalid(this.room.allSurfaces) && (r[t].markup(), console.log(r[t]), console.log(r[t].totalLength), console.log(r[t].arrivalTime(this.c)), console.log(h(e)), i++);
