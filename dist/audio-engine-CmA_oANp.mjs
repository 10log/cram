import { O as e, t } from "./FileSaver.min-DhK9iPpQ.mjs";
...
function o(e, t) {
	let n = "pcm" + e + (t ? "f" : ""), r = a[n];
	if (!r) throw TypeError("Unsupported data format: " + n);
	return r;
}
function s(e, t) {
	let n = t.sampleRate || 48e3, r = !!(t.float || t.floatingPoint), i = r ? 32 : t.bitDepth | 0 || 16, a = e.length, s = e[0].length, c = /* @__PURE__ */ new ArrayBuffer(44 + s * a * (i >> 3)), l = new DataView(c), u = 0;
	function d(e) {
		l.setUint8(u++, e);
	}
	function f(e) {
	...
	return m("RIFF"), p(c.byteLength - 8), m("WAVE"), m("fmt "), p(16), f(r ? 3 : 1), f(a), p(n), p(n * a * (i >> 3)), f(a * (i >> 3)), f(i), m("data"), p(c.byteLength - 44), o(i, r)(c, u, e, a, s), new Uint8Array(c);
}
function c(e, { sampleRate: t = 44100, bitDepth: n = 16 }) {
	let r = s(e, {
		channels: e.length,
		sampleRate: t,
		bitDepth: n
...
var f = window.AudioContext || window.webkitAudioContext, p = window.OfflineAudioContext || window.webkitOfflineAudioContext, m = new class {
	context;
	constructor() {
		this.context = new f();
	}
	...
	createFilteredSource(e, t, n = 1.414, a = 1, o = this.context) {
		let s = r(1, t), c = i(1, t), l = {
			source: this.createBufferSource(e, o),
			lowpass: this.createBiquadFilter("lowpass", c, n, 1, o),
			highpass: this.createBiquadFilter("highpass", s, n, 1, o),
			gain: this.createGainNode(a, o)
		};
	...
	createFilteredSources(e, t, n = this.context) {
		d(e.length === t.length, "There should be exactly one frequency for each data buffer.");
		let r = [];
	...
	async testFilters(e, t = 44100) {
		...
		let o = c([l((await this.renderContextAsync(r)).getChannelData(0))], {
			sampleRate: t,
			bitDepth: 32
		});
		(0, u.saveAs)(o, "testFilters.wav");
	}
	get sampleRate() {
...
//# sourceMappingURL=audio-engine-CmA_oANp.mjs.map