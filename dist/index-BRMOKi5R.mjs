import { l as B, u as k, r as T, n as X, E as D, o as j, q as N, x as z } from "./index--vKOn3aE.mjs";
...
import { S as J } from "./solver-BmP-9ULQ.mjs";
class Z {
  /**
        ...
        if (i.dependencies !== null)
          for (let c = 0; c < i.dependencies.length; c++) {
            ...
            if (p.name !== i.name) {
              ...
              if (!b)
                return "Variable dependency not found. Variable=" + i.name + ", dependency=" + p.name;
            }
...
` + o.fragmentShader;
      ...
      for (let o = 0, d = this.variables.length; o < d; o++) {
        ...
        if (c.dependencies !== null) {
          ...
          for (let b = 0, S = c.dependencies.length; b < S; b++) {
            ...
            p[R.name].value = R.renderTargets[n].texture;
          }
        }
    ...
    this.createShaderMaterial = f, this.createRenderTarget = function(n, i, o, d, c, p) {
      return n = n || e, i = i || t, o = o || V, d = d || V, c = c || y, p = p || y, new A(n, i, {
        wrapS: o,
        wrapT: d,
        minFilter: c,
        magFilter: p,
...
function H(m, e, t, r) {
  const a = [];
  let s, l, u, h, f, g, x, n, i, o, d;
  if (u = t - m, h = r - e, f = Math.abs(u), g = Math.abs(h), x = 2 * g - f, n = 2 * f - g, g <= f)
    for (u >= 0 ? (s = m, l = e, i = t) : (s = t, l = r, i = m), a.push([s, l]), d = 0; s < i; d++)
      s = s + 1, x < 0 ? x = x + 2 * g : (u < 0 && h < 0 || u > 0 && h > 0 ? l = l + 1 : l = l - 1, x = x + 2 * (g - f)), a.push([s, l]);
  else
    for (h >= 0 ? (s = m, l = e, o = r) : (s = t, l = r, o = e), a.push([s, l]), d = 0; l < o; d++)
      l = l + 1, n <= 0 ? n = n + 2 * f : (u < 0 && h < 0 || u > 0 && h > 0 ? s = s + 1 : s = s - 1, n = n + 2 * (f - g)), a.push([s, l]);
  return a;
}
class I {
  enabled;
...
class he extends J {
  ...
  init() {
    ...
    ]), a = w.waterVert, s = w.waterFrag, l = M, u = new U({
      uniforms: r,
      vertexShader: a,
      fragmentShader: s,
      side: l,
  ...
  addWall(e) {
    const t = _(Math.floor((e.x1 - this.offsetX) / this.cellSize), 0, this.nx - 1), r = _(Math.floor((e.y1 - this.offsetY) / this.cellSize), 0, this.ny - 1), a = _(Math.floor((e.x2 - this.offsetX) / this.cellSize), 0, this.nx - 1), s = _(Math.floor((e.y2 - this.offsetY) / this.cellSize), 0, this.ny - 1);
...
//# sourceMappingURL=index-BRMOKi5R.mjs.map
