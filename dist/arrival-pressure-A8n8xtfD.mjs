...
import { i as e, n as t, r as n, t as r } from "./convert-GmiMppOk.mjs";
import { r as i } from "./air-attenuation-CZldbT4Y.mjs";
...
function l(o, l, u) {
	...
	if (l.bandEnergy) {
		let e = n(t(o)), i = l.points.length - 1, s = i >= 1 ? l.points[i].distanceTo(l.points[i - 1]) : l.length, c = a(s), u = Array(d.length);
		for (let t = 0; t < d.length; t++) {
			let n = e[t] * l.bandEnergy[t] * c;
			u[t] = r([n])[0] * p;
		}
		return u;
	}
	let g = a(l.length), _ = n(t(o));
