import { O as e, S as t, _ as n, n as r, o as i, s as a, t as o, y as s } from "./FileSaver.min-DhK9iPpQ.mjs";
import { t as c } from "./audio-engine-CmA_oANp.mjs";
...
var g = [
	...
	T30;
	constructor(e = h) {
		super(e), this.kind = "energydecay", this.name = e.name || h.name, this.broadbandIRData = /* @__PURE__ */ new Float32Array(), this.broadbandIRSampleRate = 0, this.uuid = t(), this.filteredData = [], this.filteredEnergyDecayData = [], this.impulseResponsePlaying = !1, this.filterTest = null, this.T15 = [], this.T20 = [], this.T30 = [];
	}
	calculateAcParams() {
	...
	play(e) {
		c.context.state === "suspended" && c.context.resume(), e.connect(c.context.destination), e.start(), n("ENERGYDECAY_SET_PROPERTY", {
			uuid: this.uuid,
			property: "impulseResponsePlaying",
			value: !0
		}), e.onended = () => {
			e.stop(), e.disconnect(c.context.destination), n("ENERGYDECAY_SET_PROPERTY", {
				uuid: this.uuid,
				property: "impulseResponsePlaying",
				value: !1
			});
...
s("ADD_ENERGYDECAY", r(_)), s("ENERGYDECAY_SET_PROPERTY", i), s("CALCULATE_AC_PARAMS", (e) => void a.getState().solvers[e].calculateAcParams());
//#endregion
export { _ as default };

//# sourceMappingURL=energy-decay-B7jvteJw.mjs.map