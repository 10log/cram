...
export declare function calculateImpulseResponseForDisplay(receiverIDs: string[], sourceIDs: string[], paths: Record<string, RayPath[]>, initialSPL: number | undefined, frequencies: number[], temperature: number, sampleRate?: number, tailOptions?: TailOptions): Promise<{
    signal: Float32Array;
    normalizedSignal: Float32Array;
}>;
