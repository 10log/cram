import { v as _, F as y, w as r, e as h, o as m, D as R, B as S, f as v } from "./index-CgcZvXNw.mjs";
import { S as D } from "./solver-BGevQtbj.mjs";
const f = {
  name: "Energy Decay"
...
function E(t) {
  t.length;
  let a = t.reverse().map((l) => Math.pow(l, 2)), s = x(a), n = t.map((l) => Math.pow(l, 2)), i = A(n);
...
//# sourceMappingURL=energy-decay-rWpByhNI.mjs.map
