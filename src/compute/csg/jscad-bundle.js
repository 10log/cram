...
// node_modules/@jscad/csg/src/core/utils.js
var require_utils = __commonJS({
  "node_modules/@jscad/csg/src/core/utils.js"(exports, module) {
    function fnNumberSort(a, b) {
      return a - b;
    }
    __name(fnNumberSort, "fnNumberSort");
    function fnSortByIndex(a, b) {
      return a.index - b.index;
    }
    __name(fnSortByIndex, "fnSortByIndex");
    var IsFloat = /* @__PURE__ */ __name(function(n) {
      return !isNaN(n) || n === Infinity || n === -Infinity;
    }, "IsFloat");
    var solve2Linear = /* @__PURE__ */ __name(function(a, b, c, d, u, v) {
      let det = a * d - b * c;
      let invdet = 1 / det;
      let x = u * d - b * v;
      let y = -u * c + a * v;
    ...
    var interpolateBetween2DPointsForY = /* @__PURE__ */ __name(function(point1, point2, y) {
      let f1 = y - point1.y;
...
// node_modules/@jscad/csg/src/core/math/Vector2.js
var require_Vector2 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Vector2.js"(exports, module) {
    var { IsFloat } = require_utils();
    var Vector2D = /* @__PURE__ */ __name(function(x, y) {
    ...
    Vector2D.prototype = {
      ...
      toVector3D: /* @__PURE__ */ __name(function(z) {
        const Vector3D = require_Vector3();
        return new Vector3D(this._x, this._y, z);
      }, "toVector3D"),
      equals: /* @__PURE__ */ __name(function(a) {
        return this._x === a._x && this._y === a._y;
      }, "equals"),
      clone: /* @__PURE__ */ __name(function() {
        return Vector2D.Create(this._x, this._y);
      }, "clone"),
      negated: /* @__PURE__ */ __name(function() {
        return Vector2D.Create(-this._x, -this._y);
      }, "negated"),
      plus: /* @__PURE__ */ __name(function(a) {
        return Vector2D.Create(this._x + a._x, this._y + a._y);
      }, "plus"),
      minus: /* @__PURE__ */ __name(function(a) {
        return Vector2D.Create(this._x - a._x, this._y - a._y);
      }, "minus"),
      times: /* @__PURE__ */ __name(function(a) {
        return Vector2D.Create(this._x * a, this._y * a);
      }, "times"),
      dividedBy: /* @__PURE__ */ __name(function(a) {
        return Vector2D.Create(this._x / a, this._y / a);
      }, "dividedBy"),
      dot: /* @__PURE__ */ __name(function(a) {
        return this._x * a._x + this._y * a._y;
      }, "dot"),
      lerp: /* @__PURE__ */ __name(function(a, t) {
        return this.plus(a.minus(this).times(t));
      }, "lerp"),
      length: /* @__PURE__ */ __name(function() {
        return Math.sqrt(this.dot(this));
      }, "length"),
      distanceTo: /* @__PURE__ */ __name(function(a) {
        return this.minus(a).length();
      }, "distanceTo"),
      distanceToSquared: /* @__PURE__ */ __name(function(a) {
        return this.minus(a).lengthSquared();
      }, "distanceToSquared"),
      lengthSquared: /* @__PURE__ */ __name(function() {
        return this.dot(this);
      }, "lengthSquared"),
      unit: /* @__PURE__ */ __name(function() {
        return this.dividedBy(this.length());
      }, "unit"),
      cross: /* @__PURE__ */ __name(function(a) {
        return this._x * a._y - this._y * a._x;
      }, "cross"),
      // returns the vector rotated by 90 degrees clockwise
      normal: /* @__PURE__ */ __name(function() {
        return Vector2D.Create(this._y, -this._x);
      }, "normal"),
      // Right multiply by a 4x4 matrix (the vector is interpreted as a row vector)
      // Returns a new Vector2D
      multiply4x4: /* @__PURE__ */ __name(function(matrix4x4) {
        return matrix4x4.leftMultiply1x2Vector(this);
      }, "multiply4x4"),
      transform: /* @__PURE__ */ __name(function(matrix4x4) {
        return matrix4x4.leftMultiply1x2Vector(this);
      }, "transform"),
      angle: /* @__PURE__ */ __name(function() {
        return this.angleRadians();
      }, "angle"),
      angleDegrees: /* @__PURE__ */ __name(function() {
        var radians = this.angleRadians();
        return 180 * radians / Math.PI;
      }, "angleDegrees"),
      angleRadians: /* @__PURE__ */ __name(function() {
        return Math.atan2(this._y, this._x);
      }, "angleRadians"),
      min: /* @__PURE__ */ __name(function(p) {
        return Vector2D.Create(
          Math.min(this._x, p._x),
          Math.min(this._y, p._y)
        );
      }, "min"),
      max: /* @__PURE__ */ __name(function(p) {
        return Vector2D.Create(
...
// node_modules/@jscad/csg/src/core/math/Vector3.js
var require_Vector3 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Vector3.js"(exports, module) {
    var { IsFloat } = require_utils();
    var Vector2D = require_Vector2();
    var Vector3D = /* @__PURE__ */ __name(function(x, y, z) {
    ...
    Vector3D.prototype = {
      ...
      randomNonParallelVector: /* @__PURE__ */ __name(function() {
        var abs = this.abs();
...
// node_modules/@jscad/csg/src/core/math/Line2.js
var require_Line2 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Line2.js"(exports, module) {
    var Vector2D = require_Vector2();
    var { solve2Linear } = require_utils();
    var Line2D = /* @__PURE__ */ __name(function(normal, w) {
    ...
    Line2D.prototype = {
      ...
      reverse: /* @__PURE__ */ __name(function() {
        return new Line2D(this.normal.negated(), -this.w);
      }, "reverse"),
      equals: /* @__PURE__ */ __name(function(l) {
        return l.normal.equals(this.normal) && l.w === this.w;
      }, "equals"),
      origin: /* @__PURE__ */ __name(function() {
        return this.normal.times(this.w);
      }, "origin"),
      direction: /* @__PURE__ */ __name(function() {
        return this.normal.normal();
      }, "direction"),
      xAtY: /* @__PURE__ */ __name(function(y) {
        let x = (this.w - this.normal._y * y) / this.normal.x;
        return x;
      }, "xAtY"),
      absDistanceToPoint: /* @__PURE__ */ __name(function(point) {
      ...
      intersectWithLine: /* @__PURE__ */ __name(function(line2d) {
...
// node_modules/@jscad/csg/src/core/constants.js
var require_constants = __commonJS({
  "node_modules/@jscad/csg/src/core/constants.js"(exports, module) {
    var _CSGDEBUG = false;
    ...
    var back = 6;
    var staticTag = 1;
    var getTag = /* @__PURE__ */ __name(() => staticTag++, "getTag");
    module.exports = {
      _CSGDEBUG,
      defaultResolution2D,
      defaultResolution3D,
...
// node_modules/@jscad/csg/src/core/math/Line3.js
var require_Line3 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Line3.js"(exports, module) {
    var Vector3D = require_Vector3();
    var { EPS } = require_constants();
    var { solve2Linear } = require_utils();
    var Line3D = /* @__PURE__ */ __name(function(point, direction) {
    ...
    Line3D.prototype = {
      intersectWithPlane: /* @__PURE__ */ __name(function(plane) {
      ...
      clone: /* @__PURE__ */ __name(function(line) {
      ...
      closestPointOnLine: /* @__PURE__ */ __name(function(point) {
        point = new Vector3D(point);
      ...
      distanceToPoint: /* @__PURE__ */ __name(function(point) {
        point = new Vector3D(point);
      ...
      equals: /* @__PURE__ */ __name(function(line3d) {
...
// node_modules/@jscad/csg/src/core/math/Plane.js
var require_Plane = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Plane.js"(exports, module) {
    var Vector3D = require_Vector3();
    var Line3D = require_Line3();
    var { EPS, getTag } = require_constants();
    var Plane = /* @__PURE__ */ __name(function(normal, w) {
      this.normal = normal;
      this.w = w;
    }, "Plane");
    ...
    Plane.prototype = {
      flipped: /* @__PURE__ */ __name(function() {
        return new Plane(this.normal.negated(), -this.w);
      }, "flipped"),
      getTag: /* @__PURE__ */ __name(function() {
        let result = this.tag;
        if (!result) {
          result = getTag();
          this.tag = result;
      ...
      equals: /* @__PURE__ */ __name(function(n) {
      ...
      splitLineBetweenPoints: /* @__PURE__ */ __name(function(p1, p2) {
        let direction = p2.minus(p1);
      ...
      // returns Vector3D
      intersectWithLine: /* @__PURE__ */ __name(function(line3d) {
      ...
      signedDistanceToPoint: /* @__PURE__ */ __name(function(point) {
      ...
      mirrorPoint: /* @__PURE__ */ __name(function(point3d) {
...
// node_modules/@jscad/csg/src/core/math/OrthoNormalBasis.js
var require_OrthoNormalBasis = __commonJS({
  "node_modules/@jscad/csg/src/core/math/OrthoNormalBasis.js"(exports, module) {
    var Vector2D = require_Vector2();
    var Vector3D = require_Vector3();
    ...
    OrthoNormalBasis.prototype = {
      ...
      to2D: /* @__PURE__ */ __name(function(vec3) {
        return new Vector2D(vec3.dot(this.u), vec3.dot(this.v));
      }, "to2D"),
      to3D: /* @__PURE__ */ __name(function(vec2) {
        return this.planeorigin.plus(this.u.times(vec2.x)).plus(this.v.times(vec2.y));
      }, "to3D"),
      line3Dto2D: /* @__PURE__ */ __name(function(line3d) {
        let a = line3d.point;
      ...
      line2Dto3D: /* @__PURE__ */ __name(function(line2d) {
        let a = line2d.origin();
...
// node_modules/@jscad/csg/src/core/math/Matrix4.js
var require_Matrix4 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Matrix4.js"(exports, module) {
    var Vector3D = require_Vector3();
    var Vector2D = require_Vector2();
    var OrthoNormalBasis = require_OrthoNormalBasis();
    var Plane = require_Plane();
    var Matrix4x4 = /* @__PURE__ */ __name(function(elements) {
      if (arguments.length >= 1) {
    ...
    Matrix4x4.prototype = {
      plus: /* @__PURE__ */ __name(function(m) {
        var r = [];
        for (var i = 0; i < 16; i++) {
      ...
      minus: /* @__PURE__ */ __name(function(m) {
        var r = [];
        for (var i = 0; i < 16; i++) {
          r[i] = this.elements[i] - m.elements[i];
        }
      ...
      multiply: /* @__PURE__ */ __name(function(m) {
      ...
      rightMultiply1x3Vector: /* @__PURE__ */ __name(function(v) {
        var v0 = v._x;
        var v1 = v._y;
        var v2 = v._z;
        var v3 = 1;
      ...
      // (result = v*M)
      // Fourth element is taken as 1
      leftMultiply1x3Vector: /* @__PURE__ */ __name(function(v) {
        var v0 = v._x;
        var v1 = v._y;
        var v2 = v._z;
        var v3 = 1;
      ...
      // (result = M*v)
      // Fourth element is taken as 1
      rightMultiply1x2Vector: /* @__PURE__ */ __name(function(v) {
        var v0 = v.x;
        var v1 = v.y;
        var v2 = 0;
        var v3 = 1;
      ...
      // (result = v*M)
      // Fourth element is taken as 1
      leftMultiply1x2Vector: /* @__PURE__ */ __name(function(v) {
        var v0 = v.x;
        var v1 = v.y;
        var v2 = 0;
        var v3 = 1;
      ...
      isMirroring: /* @__PURE__ */ __name(function() {
...
// node_modules/@jscad/csg/src/core/mutators.js
var require_mutators = __commonJS({
  "node_modules/@jscad/csg/src/core/mutators.js"(exports, module) {
    var Matrix4x4 = require_Matrix4();
    var Vector3D = require_Vector3();
    var Plane = require_Plane();
    var addTransformationMethodsToPrototype = /* @__PURE__ */ __name(function(prot) {
    ...
    var addCenteringToPrototype = /* @__PURE__ */ __name(function(prot, axes) {
...
// node_modules/@jscad/csg/src/core/math/Vertex3.js
var require_Vertex3 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Vertex3.js"(exports, module) {
    var Vector3D = require_Vector3();
    var { getTag } = require_constants();
    var Vertex = /* @__PURE__ */ __name(function(pos) {
      this.pos = pos;
    }, "Vertex");
    ...
    Vertex.prototype = {
      ...
      interpolate: /* @__PURE__ */ __name(function(other, t) {
...
// node_modules/@jscad/csg/src/core/connectors.js
var require_connectors = __commonJS({
  "node_modules/@jscad/csg/src/core/connectors.js"(exports, module) {
    var Vector3D = require_Vector3();
    var Line3D = require_Line3();
    var Matrix4x4 = require_Matrix4();
    var OrthoNormalBasis = require_OrthoNormalBasis();
    var Plane = require_Plane();
    var Connector = /* @__PURE__ */ __name(function(point, axisvector, normalvector) {
    ...
    Connector.prototype = {
      normalized: /* @__PURE__ */ __name(function() {
      ...
      //                   connectors
      getTransformationTo: /* @__PURE__ */ __name(function(other, mirror, normalrotation) {
      ...
      axisLine: /* @__PURE__ */ __name(function() {
        return new Line3D(this.point, this.axisvector);
      }, "axisLine"),
      // creates a new Connector, with the connection point moved in the direction of the axisvector
      extend: /* @__PURE__ */ __name(function(distance) {
    ...
    var ConnectorList = /* @__PURE__ */ __name(function(connectors) {
    ...
    ConnectorList.prototype = {
      setClosed: /* @__PURE__ */ __name(function(closed) {
        this.closed = !!closed;
      }, "setClosed"),
      appendConnector: /* @__PURE__ */ __name(function(conn) {
       ...
       */
      followWith: /* @__PURE__ */ __name(function(cagish) {
...
// node_modules/@jscad/csg/src/core/math/Vertex2.js
var require_Vertex2 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Vertex2.js"(exports, module) {
    var Vector2D = require_Vector2();
    var { getTag } = require_constants();
    var Vertex = /* @__PURE__ */ __name(function(pos) {
      this.pos = pos;
...
// node_modules/@jscad/csg/src/core/math/Side.js
var require_Side = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Side.js"(exports, module) {
    var Vector2D = require_Vector2();
    var Vertex = require_Vertex2();
    var Vertex3 = require_Vertex3();
    var Polygon = require_Polygon3();
    var { getTag } = require_constants();
    var Side = /* @__PURE__ */ __name(function(vertex0, vertex1) {
    ...
    Side.prototype = {
      ...
      toPolygon3D: /* @__PURE__ */ __name(function(z0, z1) {
        const vertices = [
...
// node_modules/@jscad/csg/src/core/math/lineUtils.js
var require_lineUtils = __commonJS({
  "node_modules/@jscad/csg/src/core/math/lineUtils.js"(exports, module) {
    var { EPS } = require_constants();
    var { solve2Linear } = require_utils();
    var linesIntersect = /* @__PURE__ */ __name(function(p0start, p0end, p1start, p1end) {
...
// node_modules/@jscad/csg/src/core/utils/cagValidation.js
var require_cagValidation = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/cagValidation.js"(exports, module) {
    var { areaEPS } = require_constants();
    var { linesIntersect } = require_lineUtils();
    var isCAGValid = /* @__PURE__ */ __name(function(CAG) {
      let errors = [];
    ...
    var isSelfIntersecting = /* @__PURE__ */ __name(function(cag, debug) {
    ...
    var hasPointInside = /* @__PURE__ */ __name(function(cag, p0) {
      let p1 = null;
      let p2 = null;
      let inside = false;
    ...
    var contains = /* @__PURE__ */ __name(function(cag1, cag2) {
...
// node_modules/@jscad/csg/src/api/ops-booleans.js
var require_ops_booleans = __commonJS({
  "node_modules/@jscad/csg/src/api/ops-booleans.js"(exports, module) {
...
// node_modules/@jscad/csg/src/core/CAGFactories.js
var require_CAGFactories = __commonJS({
  "node_modules/@jscad/csg/src/core/CAGFactories.js"(exports, module) {
    ...
    var fromSides = /* @__PURE__ */ __name(function(sides) {
      const CAG = require_CAG();
      let cag = new CAG();
      cag.sides = sides;
      return cag;
    }, "fromSides");
    var fromFakeCSG = /* @__PURE__ */ __name(function(csg) {
    ...
    var fromPoints = /* @__PURE__ */ __name(function(points) {
      if (!points) {
    ...
    var fromPointsArray = /* @__PURE__ */ __name(function(points) {
      if (points.length < 3) {
    ...
    var fromNestedPointsArray = /* @__PURE__ */ __name(function(points) {
      if (points.length === 1) {
      ...
      return cag;
    }, "fromNestedPointsArray");
    var fromObject = /* @__PURE__ */ __name(function(obj) {
    ...
    var fromPointsNoCheck = /* @__PURE__ */ __name(function(points) {
      let sides = [];
    ...
    var fromPath2 = /* @__PURE__ */ __name(function(path) {
      if (!path.isClosed()) throw new Error("The path should be closed!");
      return fromPoints(path.getPoints());
    }, "fromPath2");
    var fromCompactBinary = /* @__PURE__ */ __name(function(bin) {
...
// node_modules/@jscad/csg/src/core/FuzzyFactory.js
var require_FuzzyFactory = __commonJS({
  "node_modules/@jscad/csg/src/core/FuzzyFactory.js"(exports, module) {
    var FuzzyFactory = /* @__PURE__ */ __name(function(numdimensions, tolerance) {
      this.lookuptable = {};
    ...
    FuzzyFactory.prototype = {
      ...
      lookupOrCreate: /* @__PURE__ */ __name(function(els, creatorCallback) {
        let hash = "";
...
// node_modules/@jscad/csg/src/core/FuzzyFactory3d.js
var require_FuzzyFactory3d = __commonJS({
  "node_modules/@jscad/csg/src/core/FuzzyFactory3d.js"(exports, module) {
    var { EPS } = require_constants();
    var Polygon = require_Polygon3();
    var FuzzyFactory = require_FuzzyFactory();
    var FuzzyCSGFactory = /* @__PURE__ */ __name(function() {
      this.vertexfactory = new FuzzyFactory(3, EPS);
      this.planefactory = new FuzzyFactory(4, EPS);
      this.polygonsharedfactory = {};
    }, "FuzzyCSGFactory");
    FuzzyCSGFactory.prototype = {
      getPolygonShared: /* @__PURE__ */ __name(function(sourceshared) {
      ...
      getVertex: /* @__PURE__ */ __name(function(sourcevertex) {
      ...
      getPlane: /* @__PURE__ */ __name(function(sourceplane) {
      ...
      getPolygon: /* @__PURE__ */ __name(function(sourcepolygon) {
...
// node_modules/@jscad/csg/src/core/FuzzyFactory2d.js
var require_FuzzyFactory2d = __commonJS({
  "node_modules/@jscad/csg/src/core/FuzzyFactory2d.js"(exports, module) {
    var FuzzyFactory = require_FuzzyFactory();
    var { EPS } = require_constants();
    var Side = require_Side();
    var FuzzyCAGFactory = /* @__PURE__ */ __name(function() {
    ...
    FuzzyCAGFactory.prototype = {
      ...
      getSide: /* @__PURE__ */ __name(function(sourceside) {
...
// node_modules/@jscad/csg/src/core/utils/canonicalize.js
var require_canonicalize = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/canonicalize.js"(exports, module) {
    var { EPS } = require_constants();
    ...
    var canonicalize = /* @__PURE__ */ __name(function(csgOrCAG, options) {
    ...
    var canonicalizeCSG = /* @__PURE__ */ __name(function(csg, options) {
    ...
    var canonicalizeCAG = /* @__PURE__ */ __name(function(cag, options) {
    ...
    var CSGFromCSGFuzzyFactory = /* @__PURE__ */ __name(function(factory, sourcecsg) {
      let _this = factory;
      let newpolygons = [];
    ...
    var CAGFromCAGFuzzyFactory = /* @__PURE__ */ __name(function(factory, sourcecag) {
      let _this = factory;
...
// node_modules/@jscad/csg/src/core/math/reTesselateCoplanarPolygons.js
var require_reTesselateCoplanarPolygons = __commonJS({
  "node_modules/@jscad/csg/src/core/math/reTesselateCoplanarPolygons.js"(exports, module) {
    var { EPS } = require_constants();
    var OrthoNormalBasis = require_OrthoNormalBasis();
    ...
    var Line2D = require_Line2();
    var Polygon = require_Polygon3();
    var reTesselateCoplanarPolygons = /* @__PURE__ */ __name(function(sourcepolygons, destpolygons) {
...
// node_modules/@jscad/csg/src/core/utils/retesellate.js
var require_retesellate = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/retesellate.js"(exports, module) {
    var FuzzyCSGFactory = require_FuzzyFactory3d();
    var reTesselateCoplanarPolygons = require_reTesselateCoplanarPolygons();
    var { fromPolygons } = require_CSGFactories();
    var reTesselate = /* @__PURE__ */ __name(function(csg) {
...
// node_modules/@jscad/csg/src/core/utils/cagMeasurements.js
var require_cagMeasurements = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/cagMeasurements.js"(exports, module) {
    var Vector2D = require_Vector2();
    var area = /* @__PURE__ */ __name(function(cag) {
      let polygonArea = 0;
      cag.sides.map(function(side) {
    ...
    var getBounds = /* @__PURE__ */ __name(function(cag) {
      let minpoint;
...
// node_modules/@jscad/csg/src/api/ops-cnc.js
var require_ops_cnc = __commonJS({
  "node_modules/@jscad/csg/src/api/ops-cnc.js"(exports, module) {
    var Matrix4x4 = require_Matrix4();
    var Vector3D = require_Vector3();
    var { Connector } = require_connectors();
    var { fromPoints } = require_CAGFactories();
    var Vector2D = require_Vector2();
    var getTransformationAndInverseTransformationToFlatLying = /* @__PURE__ */ __name(function(_csg) {
...
// node_modules/@jscad/csg/src/api/optionParsers.js
var require_optionParsers = __commonJS({
  "node_modules/@jscad/csg/src/api/optionParsers.js"(exports, module) {
    var Vector3D = require_Vector3();
    var Vector2D = require_Vector2();
    var parseOption = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
    ...
    var parseOptionAs3DVector = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
      var result = parseOption(options, optionname, defaultvalue);
      result = new Vector3D(result);
      return result;
    }, "parseOptionAs3DVector");
    var parseOptionAs3DVectorList = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
      var result = parseOption(options, optionname, defaultvalue);
      return result.map(function(res) {
        return new Vector3D(res);
      });
    }, "parseOptionAs3DVectorList");
    var parseOptionAs2DVector = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
      var result = parseOption(options, optionname, defaultvalue);
      result = new Vector2D(result);
      return result;
    }, "parseOptionAs2DVector");
    var parseOptionAsFloat = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
      var result = parseOption(options, optionname, defaultvalue);
    ...
    var parseOptionAsInt = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
      var result = parseOption(options, optionname, defaultvalue);
    ...
    var parseOptionAsBool = /* @__PURE__ */ __name(function(options, optionname, defaultvalue) {
      var result = parseOption(options, optionname, defaultvalue);
      if (typeof result === "string") {
...
// node_modules/@jscad/csg/src/core/math/Path2.js
var require_Path2 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Path2.js"(exports, module) {
    var Vector2D = require_Vector2();
    ...
    var Vertex = require_Vertex2();
    var Side = require_Side();
    var Path2D = /* @__PURE__ */ __name(function(points, closed) {
      closed = !!closed;
      points = points || [];
      let prevpoint = null;
    ...
    Path2D.prototype = {
      concat: /* @__PURE__ */ __name(function(otherpath) {
       ...
       */
      getPoints: /* @__PURE__ */ __name(function() {
        return this.points;
      }, "getPoints"),
      /**
       ...
       */
      appendPoint: /* @__PURE__ */ __name(function(point) {
        if (this.closed) {
       ...
       * @returns {Path2D} new Path2D object (not closed)
       */
      appendPoints: /* @__PURE__ */ __name(function(points) {
        if (this.closed) {
          throw new Error("Path must not be closed");
        }
       ...
       */
      isClosed: /* @__PURE__ */ __name(function() {
        return this.closed;
      }, "isClosed"),
      /**
       ...
       */
      getTurn: /* @__PURE__ */ __name(function() {
      ...
      rectangularExtrude: /* @__PURE__ */ __name(function(width, height, resolution) {
      ...
      expandToCAG: /* @__PURE__ */ __name(function(pathradius, resolution) {
        const CAG = require_CAG();
        let sides = [];
      ...
      innerToCAG: /* @__PURE__ */ __name(function() {
        const CAG = require_CAG();
       ...
       */
      appendBezier: /* @__PURE__ */ __name(function(controlpoints, options) {
        if (arguments.length < 2) {
          options = {};
        }
        if (this.closed) {
        ...
        let getPointForT = /* @__PURE__ */ __name(function(t) {
          let t_k = 1;
       ...
       * p1 = p1.close();
       */
      appendArc: /* @__PURE__ */ __name(function(endpoint, options) {
        let decimals = 1e5;
        if (arguments.length < 2) {
          options = {};
        }
...
// node_modules/@jscad/csg/src/api/helpers.js
var require_helpers = __commonJS({
  "node_modules/@jscad/csg/src/api/helpers.js"(exports, module) {
    var Vertex3 = require_Vertex3();
    var Vector3 = require_Vector3();
    var Polygon3 = require_Polygon3();
    var polygonFromPoints = /* @__PURE__ */ __name((points) => {
      const vertices = points.map((point) => new Vertex3(new Vector3(point)));
      return new Polygon3(vertices);
    }, "polygonFromPoints");
    var rightMultiply1x3VectorToArray = /* @__PURE__ */ __name((matrix, vector) => {
    ...
    __name(clamp, "clamp");
    var cagToPointsArray = /* @__PURE__ */ __name((input) => {
      let points;
      if ("sides" in input) {
        points = [];
...
// node_modules/@jscad/csg/src/api/ops-extrusions.js
var require_ops_extrusions = __commonJS({
  "node_modules/@jscad/csg/src/api/ops-extrusions.js"(exports, module) {
    ...
    var { fromPoints } = require_CAGFactories();
    var extrudeInOrthonormalBasis = /* @__PURE__ */ __name(function(cag, orthonormalbasis, depth, options) {
    ...
    var extrudeInPlane = /* @__PURE__ */ __name(function(cag, axis1, axis2, depth, options) {
      return extrudeInOrthonormalBasis(cag, OrthoNormalBasis.GetCartesian(axis1, axis2), depth, options);
    }, "extrudeInPlane");
    var extrude = /* @__PURE__ */ __name(function(cag, options) {
      const CSG = require_CSG();
      if (cag.sides.length === 0) {
        return new CSG();
      }
    ...
    var rotateExtrude = /* @__PURE__ */ __name(function(cag, options) {
    ...
    __name(linear_extrude, "linear_extrude");
    ...
    __name(rotate_extrude, "rotate_extrude");
    ...
    __name(rectangular_extrude, "rectangular_extrude");
    module.exports = {
      extrudeInOrthonormalBasis,
      extrudeInPlane,
      extrude,
...
// node_modules/@jscad/csg/src/api/cagOutlinePaths.js
var require_cagOutlinePaths = __commonJS({
  "node_modules/@jscad/csg/src/api/cagOutlinePaths.js"(exports, module) {
    var Path2D = require_Path2();
    var cagoutlinePaths = /* @__PURE__ */ __name(function(_cag) {
      let cag = _cag.canonicalized();
...
// node_modules/@jscad/csg/src/core/utils/toArray.js
var require_toArray = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/toArray.js"(exports, module) {
...
// node_modules/@jscad/csg/src/api/center.js
var require_center = __commonJS({
  "node_modules/@jscad/csg/src/api/center.js"(exports, module) {
    var toArray = require_toArray();
    var center = /* @__PURE__ */ __name(function(options, objects) {
      const defaults = {
        axes: [true, true, true],
        center: [0, 0, 0]
...
// node_modules/@jscad/csg/src/api/ops-expandContract.js
var require_ops_expandContract = __commonJS({
  "node_modules/@jscad/csg/src/api/ops-expandContract.js"(exports, module) {
    var { EPS, angleEPS } = require_constants();
    var Vertex = require_Vertex3();
    var Vector2D = require_Vector2();
    var Polygon = require_Polygon3();
    ...
    var expand = /* @__PURE__ */ __name(function(shape, radius, resolution) {
      let result;
      if (isCSG(shape)) {
    ...
    var contract = /* @__PURE__ */ __name(function(shape, radius, resolution) {
      let result;
      if (isCSG(shape)) {
    ...
    var expandedShellOfCAG = /* @__PURE__ */ __name(function(_cag, radius, resolution) {
      const CAG = require_CAG();
    ...
    var expandedShellOfCCSG = /* @__PURE__ */ __name(function(_csg, radius, resolution, unionWithThis) {
      const CSG = require_CSG();
...
// node_modules/@jscad/csg/src/core/CAG.js
var require_CAG = __commonJS({
  "node_modules/@jscad/csg/src/core/CAG.js"(exports, module) {
    var { Connector } = require_connectors();
    ...
    var CAG = /* @__PURE__ */ __name(function() {
      this.sides = [];
      this.isCanonicalized = false;
    }, "CAG");
    CAG.prototype = {
      union: /* @__PURE__ */ __name(function(cag) {
        let cags;
      ...
      subtract: /* @__PURE__ */ __name(function(cag) {
        let cags;
        if (cag instanceof Array) {
          cags = cag;
        } else {
      ...
      intersect: /* @__PURE__ */ __name(function(cag) {
        let cags;
        if (cag instanceof Array) {
          cags = cag;
        } else {
      ...
      // ALIAS !
      center: /* @__PURE__ */ __name(function(axes) {
        return center({ axes }, [this]);
      }, "center"),
      // ALIAS !
      expandedShell: /* @__PURE__ */ __name(function(radius, resolution) {
        return expandedShellOfCAG(this, radius, resolution);
      }, "expandedShell"),
      // ALIAS !
      expand: /* @__PURE__ */ __name(function(radius, resolution) {
        return expand(this, radius, resolution);
      }, "expand"),
      contract: /* @__PURE__ */ __name(function(radius, resolution) {
        return contract(this, radius, resolution);
      }, "contract"),
      // ALIAS !
      area: /* @__PURE__ */ __name(function() {
        return area(this);
      }, "area"),
      // ALIAS !
      ...
      // ALIAS !
      isSelfIntersecting: /* @__PURE__ */ __name(function(debug) {
        return isSelfIntersecting(this, debug);
      }, "isSelfIntersecting"),
      // extrusion: all aliases to simple functions
      extrudeInOrthonormalBasis: /* @__PURE__ */ __name(function(orthonormalbasis, depth, options) {
        return extrudeInOrthonormalBasis(this, orthonormalbasis, depth, options);
      }, "extrudeInOrthonormalBasis"),
      // ALIAS !
      extrudeInPlane: /* @__PURE__ */ __name(function(axis1, axis2, depth, options) {
        return extrudeInPlane(this, axis1, axis2, depth, options);
      }, "extrudeInPlane"),
      // ALIAS !
      extrude: /* @__PURE__ */ __name(function(options) {
        return extrude(this, options);
      }, "extrude"),
      // ALIAS !
      rotateExtrude: /* @__PURE__ */ __name(function(options) {
      ...
      // ALIAS !
      canonicalized: /* @__PURE__ */ __name(function() {
        return canonicalize(this);
      }, "canonicalized"),
      // ALIAS !
      reTesselated: /* @__PURE__ */ __name(function() {
        return retesselate(this);
      }, "reTesselated"),
      // ALIAS !
      getOutlinePaths: /* @__PURE__ */ __name(function() {
        return cagoutlinePaths(this);
      }, "getOutlinePaths"),
      // ALIAS !
      overCutInsideCorners: /* @__PURE__ */ __name(function(cutterradius) {
        return overCutInsideCorners(this, cutterradius);
      }, "overCutInsideCorners"),
      // ALIAS !
      hasPointInside: /* @__PURE__ */ __name(function(point) {
      ...
      _toCSGWall: /* @__PURE__ */ __name(function(z0, z1) {
        let polygons = this.sides.map(function(side) {
          return side.toPolygon3D(z0, z1);
        });
        return fromPolygons(polygons);
      }, "_toCSGWall"),
      _toVector3DPairs: /* @__PURE__ */ __name(function(m) {
      ...
      /*
        ...
        */
      _toPlanePolygons: /* @__PURE__ */ __name(function(options) {
        const defaults = {
          flipped: false
        };
        options = Object.assign({}, defaults, options);
      ...
      /*
        ...
        */
      _toWallPolygons: /* @__PURE__ */ __name(function(options) {
        let origin = [0, 0, 0];
        let defaultAxis = [0, 0, 1];
        let defaultNormal = [0, 1, 0];
        let thisConnector = new Connector(origin, defaultAxis, defaultNormal);
       ...
       */
      toPoints: /* @__PURE__ */ __name(function() {
      ...
      */
      toCompactBinary: /* @__PURE__ */ __name(function() {
...
// node_modules/@jscad/csg/src/core/math/Polygon2.js
var require_Polygon2 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Polygon2.js"(exports, module) {
    var CAG = require_CAG();
    var { fromPoints } = require_CAGFactories();
    ...
    __name(Polygon2D, "Polygon2D");
    Polygon2D.prototype = CAG.prototype;
    module.exports = Polygon2D;
  }
});

// node_modules/@jscad/csg/src/core/CSGFactories.js
var require_CSGFactories = __commonJS({
  "node_modules/@jscad/csg/src/core/CSGFactories.js"(exports, module) {
    var Vector3D = require_Vector3();
    var Vertex = require_Vertex3();
    var Plane = require_Plane();
    var Polygon2D = require_Polygon2();
    var Polygon3D = require_Polygon3();
    var fromPolygons = /* @__PURE__ */ __name(function(polygons) {
      const CSG = require_CSG();
      let csg = new CSG();
    ...
    __name(fromCompactBinary, "fromCompactBinary");
    module.exports = {
      fromPolygons,
      fromSlices,
      fromObject,
...
// node_modules/@jscad/csg/src/api/solidFromSlices.js
var require_solidFromSlices = __commonJS({
  "node_modules/@jscad/csg/src/api/solidFromSlices.js"(exports, module) {
    var Polygon = require_Polygon3();
    var { fromPolygons } = require_CSGFactories();
    var { fnSortByIndex } = require_utils();
    var solidFromSlices = /* @__PURE__ */ __name(function(polygon, options) {
      let polygons = [];
      let csg = null;
      let prev = null;
      let bottom = null;
      ...
      if (!fnCallback) {
        ...
        fnCallback = /* @__PURE__ */ __name(function(t, slice) {
    ...
    var _addWalls = /* @__PURE__ */ __name(function(walls, bottom, top, bFlipped) {
      ...
      let getTriangle = /* @__PURE__ */ __name(function addWallsPutTriangle(pointA, pointB, pointC, color2) {
...
// node_modules/@jscad/csg/src/core/math/Polygon3.js
var require_Polygon3 = __commonJS({
  "node_modules/@jscad/csg/src/core/math/Polygon3.js"(exports, module) {
    var Vector3D = require_Vector3();
    var Vertex = require_Vertex3();
    var Matrix4x4 = require_Matrix4();
    var { _CSGDEBUG, EPS, getTag, areaEPS } = require_constants();
    var Polygon = /* @__PURE__ */ __name(function(vertices, shared, plane) {
    ...
    Polygon.prototype = {
      ...
      getArea: /* @__PURE__ */ __name(function() {
        let polygonArea = 0;
        for (let i = 0; i < this.vertices.length - 2; i++) {
      ...
      getTetraFeatures: /* @__PURE__ */ __name(function(features) {
        let result = [];
      ...
      extrude: /* @__PURE__ */ __name(function(offsetvector) {
        const { fromPolygons } = require_CSGFactories();
        let newpolygons = [];
        let polygon1 = this;
      ...
      boundingBox: /* @__PURE__ */ __name(function() {
      ...
      projectToOrthoNormalBasis: /* @__PURE__ */ __name(function(orthobasis) {
        const CAG = require_CAG();
      ...
      // ALIAS ONLY!!
      solidFromSlices: /* @__PURE__ */ __name(function(options) {
...
// node_modules/@jscad/csg/src/core/trees.js
var require_trees = __commonJS({
  "node_modules/@jscad/csg/src/core/trees.js"(exports, module) {
    ...
    __name(splitPolygonByPlane, "splitPolygonByPlane");
    var PolygonTreeNode = /* @__PURE__ */ __name(function() {
      this.parent = null;
      this.children = [];
      this.polygon = null;
      this.removed = false;
    ...
    PolygonTreeNode.prototype = {
      ...
      addPolygons: /* @__PURE__ */ __name(function(polygons) {
        if (!this.isRootNode()) {
      ...
      isRemoved: /* @__PURE__ */ __name(function() {
        return this.removed;
      }, "isRemoved"),
      isRootNode: /* @__PURE__ */ __name(function() {
        return !this.parent;
      }, "isRootNode"),
      // invert all polygons in the tree. Call on the root node
      invert: /* @__PURE__ */ __name(function() {
        if (!this.isRootNode()) throw new Error("Assertion failed");
        this.invertSub();
      }, "invert"),
      getPolygon: /* @__PURE__ */ __name(function() {
        if (!this.polygon) throw new Error("Assertion failed");
        return this.polygon;
      }, "getPolygon"),
      getPolygons: /* @__PURE__ */ __name(function(result) {
        let children = [this];
        let queue = [children];
        let i, j, l, node;
      ...
      splitByPlane: /* @__PURE__ */ __name(function(plane, coplanarfrontnodes, coplanarbacknodes, frontnodes, backnodes) {
      ...
      _splitByPlane: /* @__PURE__ */ __name(function(plane, coplanarfrontnodes, coplanarbacknodes, frontnodes, backnodes) {
      ...
      addChild: /* @__PURE__ */ __name(function(polygon) {
      ...
      invertSub: /* @__PURE__ */ __name(function() {
        let children = [this];
        let queue = [children];
        let i, j, l, node;
        for (i = 0; i < queue.length; i++) {
      ...
      recursivelyInvalidatePolygon: /* @__PURE__ */ __name(function() {
        let node = this;
        while (node.polygon) {
          node.polygon = null;
          if (node.parent) {
    ...
    var Tree = /* @__PURE__ */ __name(function(polygons) {
    ...
    Tree.prototype = {
      ...
      // `tree`.
      clipTo: /* @__PURE__ */ __name(function(tree, alsoRemovecoplanarFront) {
        alsoRemovecoplanarFront = !!alsoRemovecoplanarFront;
        this.rootnode.clipTo(tree, alsoRemovecoplanarFront);
      }, "clipTo"),
      allPolygons: /* @__PURE__ */ __name(function() {
        let result = [];
    ...
    var Node = /* @__PURE__ */ __name(function(parent) {
      this.plane = null;
      this.front = null;
      this.back = null;
    ...
    Node.prototype = {
      ...
      clipPolygons: /* @__PURE__ */ __name(function(polygontreenodes, alsoRemovecoplanarFront) {
      ...
      addPolygonTreeNodes: /* @__PURE__ */ __name(function(polygontreenodes) {
        let args = { "node": this, "polygontreenodes": polygontreenodes };
        let node;
        let stack = [];
        do {
      ...
      getParentPlaneNormals: /* @__PURE__ */ __name(function(normals, maxdepth) {
        if (maxdepth > 0) {
          if (this.parent) {
...
// node_modules/@jscad/csg/src/core/Properties.js
var require_Properties = __commonJS({
  "node_modules/@jscad/csg/src/core/Properties.js"(exports, module) {
    var Properties = /* @__PURE__ */ __name(function() {
    }, "Properties");
    Properties.prototype = {
      _transform: /* @__PURE__ */ __name(function(matrix4x4) {
        let result = new Properties();
        Properties.transformObj(this, result, matrix4x4);
        return result;
      }, "_transform"),
      _merge: /* @__PURE__ */ __name(function(otherproperties) {
        let result = new Properties();
...
// node_modules/@jscad/csg/src/core/utils/fixTJunctions.js
var require_fixTJunctions = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/fixTJunctions.js"(exports, module) {
    var { EPS } = require_constants();
    var Polygon = require_Polygon3();
    var Plane = require_Plane();
    ...
    __name(deleteSide, "deleteSide");
    var fixTJunctions = /* @__PURE__ */ __name(function(fromPolygons, csg) {
                    ...
                    if (t > 0 && t < 1) {
                      ...
                      if (distancesquared < EPS * EPS) {
                        ...
                        if (isNaN(newpolygon.plane.w)) {
                          let found = false;
                          let loop = /* @__PURE__ */ __name(function(callback) {
...
// node_modules/@jscad/csg/src/core/utils/csgMeasurements.js
var require_csgMeasurements = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/csgMeasurements.js"(exports, module) {
    var Vector3D = require_Vector3();
    var bounds = /* @__PURE__ */ __name(function(csg) {
...
// node_modules/@jscad/csg/src/core/utils/csgProjections.js
var require_csgProjections = __commonJS({
  "node_modules/@jscad/csg/src/core/utils/csgProjections.js"(exports, module) {
    var CAG = require_CAG();
    var { EPS } = require_constants();
    var projectToOrthoNormalBasis = /* @__PURE__ */ __name(function(csg, orthobasis) {
      let cags = [];
...
// node_modules/@jscad/csg/src/api/ops-cuts.js
var require_ops_cuts = __commonJS({
  "node_modules/@jscad/csg/src/api/ops-cuts.js"(exports, module) {
    var { EPS } = require_constants();
    var Plane = require_Plane();
    ...
    var Polygon3 = require_Polygon3();
    var OrthoNormalBasis = require_OrthoNormalBasis();
    var sectionCut = /* @__PURE__ */ __name(function(csg, orthobasis) {
    ...
    var cutByPlane = /* @__PURE__ */ __name(function(csg, plane) {
...
// node_modules/@jscad/csg/src/core/CSG.js
var require_CSG = __commonJS({
  "node_modules/@jscad/csg/src/core/CSG.js"(exports, module) {
    ...
    var CSG = /* @__PURE__ */ __name(function() {
      this.polygons = [];
    ...
    CSG.prototype = {
       ...
       *      +-------+            +-------+
       */
      union: /* @__PURE__ */ __name(function(csg) {
        let csgs;
      ...
      unionSub: /* @__PURE__ */ __name(function(csg, retesselate2, canonicalize2) {
      ...
      unionForNonIntersecting: /* @__PURE__ */ __name(function(csg) {
       ...
       *      +-------+
       */
      subtract: /* @__PURE__ */ __name(function(csg) {
        let csgs;
        if (csg instanceof Array) {
          csgs = csg;
        } else {
      ...
      subtractSub: /* @__PURE__ */ __name(function(csg, retesselate2, canonicalize2) {
        let a = new Tree(this.polygons);
        let b = new Tree(csg.polygons);
        a.invert();
        a.clipTo(b);
       ...
       *      +-------+
       */
      intersect: /* @__PURE__ */ __name(function(csg) {
        let csgs;
        if (csg instanceof Array) {
          csgs = csg;
        } else {
      ...
      intersectSub: /* @__PURE__ */ __name(function(csg, retesselate2, canonicalize2) {
        let a = new Tree(this.polygons);
        let b = new Tree(csg.polygons);
        a.invert();
        b.clipTo(a);
      ...
      transform1: /* @__PURE__ */ __name(function(matrix4x4) {
      ...
      // ALIAS !
      expandedShell: /* @__PURE__ */ __name(function(radius, resolution, unionWithThis) {
        return expandedShellOfCCSG(this, radius, resolution, unionWithThis);
      }, "expandedShell"),
      // cut the solid at a plane, and stretch the cross-section found along plane normal
      // note: only used in roundedCube() internally
      stretchAtPlane: /* @__PURE__ */ __name(function(normal, point, length) {
      ...
      // ALIAS !
      fixTJunctions: /* @__PURE__ */ __name(function() {
       ...
       * @param  {CSG} csg
       */
      mayOverlap: /* @__PURE__ */ __name(function(csg) {
      ...
      // ALIAS !
      cutByPlane: /* @__PURE__ */ __name(function(plane) {
       ...
       */
      connectTo: /* @__PURE__ */ __name(function(myConnector, otherConnector, mirror, normalrotation) {
       ...
       */
      setShared: /* @__PURE__ */ __name(function(shared) {
      ...
      // ALIAS !
      getTransformationAndInverseTransformationToFlatLying: /* @__PURE__ */ __name(function() {
        return getTransformationAndInverseTransformationToFlatLying(this);
      }, "getTransformationAndInverseTransformationToFlatLying"),
      // ALIAS !
      getTransformationToFlatLying: /* @__PURE__ */ __name(function() {
        return getTransformationToFlatLying(this);
      }, "getTransformationToFlatLying"),
      // ALIAS !
      lieFlat: /* @__PURE__ */ __name(function() {
        return lieFlat(this);
      }, "lieFlat"),
      ...
      sectionCut: /* @__PURE__ */ __name(function(orthobasis) {
       ...
       */
      getFeatures: /* @__PURE__ */ __name(function(features) {
      ...
      toPolygons: /* @__PURE__ */ __name(function() {
       ...
       */
      toTriangles: /* @__PURE__ */ __name(function() {
        let polygons = [];
...
// node_modules/@jscad/csg/src/api/primitives2d.js
var require_primitives2d = __commonJS({
  "node_modules/@jscad/csg/src/api/primitives2d.js"(exports, module) {
    var CAG = require_CAG();
    ...
    var circle = /* @__PURE__ */ __name(function(options) {
      options = options || {};
    ...
    var ellipse = /* @__PURE__ */ __name(function(options) {
      options = options || {};
    ...
    var rectangle = /* @__PURE__ */ __name(function(options) {
      options = options || {};
      let c, r;
    ...
    var roundedRectangle = /* @__PURE__ */ __name(function(options) {
      options = options || {};
      let center, radius;
      if ("corner1" in options || "corner2" in options) {
        if ("center" in options || "radius" in options) {
...
// node_modules/@jscad/csg/src/api/primitives3d.js
var require_primitives3d = __commonJS({
  "node_modules/@jscad/csg/src/api/primitives3d.js"(exports, module) {
    ...
    var Properties = require_Properties();
    var { fromPolygons } = require_CSGFactories();
    var cube = /* @__PURE__ */ __name(function(options) {
      let c;
      let r;
      let corner1;
      let corner2;
    ...
    var sphere = /* @__PURE__ */ __name(function(options) {
      options = options || {};
    ...
    var cylinder = /* @__PURE__ */ __name(function(options) {
    ...
    var roundedCylinder = /* @__PURE__ */ __name(function(options) {
    ...
    var cylinderElliptic = /* @__PURE__ */ __name(function(options) {
      let s = parseOptionAs3DVector(options, "start", [0, -1, 0]);
      let e = parseOptionAs3DVector(options, "end", [0, 1, 0]);
      let r = parseOptionAs2DVector(options, "radius", [1, 1]);
    ...
    var roundedCube = /* @__PURE__ */ __name(function(options) {
      let minRR = 0.01;
      let center;
      let cuberadius;
      let corner1;
    ...
    var polyhedron = /* @__PURE__ */ __name(function(options) {
      options = options || {};
...
// node_modules/@jscad/csg/src/api/debugHelpers.js
var require_debugHelpers = __commonJS({
  "node_modules/@jscad/csg/src/api/debugHelpers.js"(exports, module) {
    var CSG = require_CSG();
    var { cube } = require_primitives3d();
    var toPointCloud = /* @__PURE__ */ __name(function(csg, cuberadius) {
...
var require_csg = __commonJS({
  "node_modules/@jscad/csg/csg.js"(exports, module) {
...
//# sourceMappingURL=jscad-bundle.js.map
